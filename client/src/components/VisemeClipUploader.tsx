        ...
        <CardContent>
          {!project?.restPositionClipUrl ? (
            ...
            <div className="space-y-3">
              <div className="relative aspect-video rounded-md overflow-hidden bg-black border-2 border-green-500/20">
                <video
                  src={project.restPositionClipUrl}
                  className="w-full h-full object-cover"
                  autoPlay
                  loop
                  muted
                  playsInline
                  data-testid="video-rest-position-preview"
                />
              ...
              <div className="flex items-center justify-between p-3 bg-muted rounded-md">
                <div className="text-sm text-muted-foreground">
                  Avatar will return to this state when idle
                </div>
